...
defmodule TalonDemo.Admin.Accounts.State do
  @moduledoc """
  Use this file to configure how Talon renders your resource

  TBD
  """
  use Talon.Resource, schema: TalonDemo.Accounts.State, concern: TalonDemo.Admin
  ...
  #   TalonDemo.Repo.preload resource, [:some_association]
  # end
